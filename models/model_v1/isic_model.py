...
TRAIN_FILE = str(_HERE / 'processed_data/train_final.csv')
TEST_FILE  = str(_HERE / 'processed_data/test_final.csv')

REPORT_DIR   = str((_HERE / '../../outputs/v1_outputs/reports').resolve())
GRAPH_DIR    = str((_HERE / '../../outputs/v1_outputs/graphs').resolve())
DPI          = 150
N_FOLDS      = 5
RANDOM_STATE = 42
